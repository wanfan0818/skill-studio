...
const README_CONTENT = `# Skill Studio Backup

This archive is an offline backup of your Claude / Codex / universal skills,
created by Skill Studio (https://github.com/Backtthefuture/huangshu).
...
Or: set up Skill Studio + connect a GitHub repo, push this content there, then
